...
some other ruleset that depends on rules_shellspec, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_shellspec=$(pwd)/rules_shellspec"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_shellspec` on your system will point to this folder.
...
https://github.com/scottpledger/rules_shellspec/actions/workflows/tag.yaml
